...
Page({
  ...
  data: {
    ...
    lists: [{
      title: "1、摇骰",
      content: '每局游戏开始时，每位游戏参与者必须摇晃自己的手机上的骰盅，以打乱骰子的点（与麻将和扑克牌洗牌的目的相同）'
    }, {
      title: "2、叫骰",
      content: '由游戏起始者率先喊出“X个Y”（即自己觉得全场一共拥有X个Y点数的骰子）。注意这里不是单纯叫骰者骰盅内真实的情况，这里是尽情发挥演技的时间。'
    }, {
      title: "",
      content: '然后根据事先约定好的方向依次“叫骰”，但是“叫骰”者喊出的数值需高于自己座位上方的人所喊出的数值总和，或者要大于上家的“X”数值。'
    }, {
      title: "3、叫斋",
      content: '通常骰子的“1”点是通用的，可以变成任何点数，但是开局喊了X个“1”，则“1”点便不再通用。'
    }, {
      title: "4、开杀",
      content: '当你根据自己骰盅内的实际情况，而不相信上一位与你相邻的叫骰者，开骰盅清点所有参加者骰子与叫骰者所喊的Y的数量。'
    }, {
      title: "5、跳杀",
      content: '类似“开杀”，但是该“开杀者”与叫骰者不相邻。这样的失败者是需要加倍喝酒。'
    }, {
      title: "6、反杀",
      content: '叫骰者被开杀后，开骰盅前有权对开杀者“加注”，通常固定，“开多少（码数）大多少(码数)”。 开杀者被“反杀”后，有全权再“反杀”多一次叫骰者。'
    }, ]
  },
  /**
   * 生命周期函数--监听页面加载
